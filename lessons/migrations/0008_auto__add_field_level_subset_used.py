...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lessons_level', 'subset_used',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['latingrammar.Subset']),
                      keep_default=False)
    ...
    models = {
        ...
        'lessons.level': {
            ...
            'subset_used': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['latingrammar.Subset']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
