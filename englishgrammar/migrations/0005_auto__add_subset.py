...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'englishgrammar.subset': {
            'Meta': {'object_name': 'Subset'},
            'conjugations': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['englishgrammar.EnglishConjugation']", 'symmetrical': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tenses': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['englishgrammar.EnglishTense']", 'symmetrical': 'False', 'blank': 'True'})
        },
