# Django settings for amoamasamat project.
...
SECRET_KEY = '+%akha4(3z3x9$dpuit-6q-z_8l201bw%hddxwwdy_u%wd9bcr'
...
ROOT_URLCONF = 'amoamasamat.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'amoamasamat.wsgi.application'
