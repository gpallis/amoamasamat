...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subset.name'
        db.add_column('latingrammar_subset', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Default Subset Name', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subset.name'
        db.delete_column('latingrammar_subset', 'name')
