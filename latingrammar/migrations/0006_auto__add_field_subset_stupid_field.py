...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subset.stupid_field'
        db.add_column('latingrammar_subset', 'stupid_field',
                      self.gf('django.db.models.fields.CharField')(default='nothing', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subset.stupid_field'
        db.delete_column('latingrammar_subset', 'stupid_field')
    ...
    models = {
        ...
        'latingrammar.subset': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'stupid_field': ('django.db.models.fields.CharField', [], {'default': "'nothing'", 'max_length': '100'}),
